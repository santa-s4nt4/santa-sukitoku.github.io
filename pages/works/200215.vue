...
<section class="container">
  <body class="allContent">
    ...
    <div class="content">
      ...
      <img
        class="magnifiable"
        src="https://lh3.googleusercontent.com/-U60QDoWTwMU/Xkzkb3Ph3gI/AAAAAAAAqdI/FXNstPrcWYQOcF9iOCKmnjH-aZ27ZdOTgCE0YBhgL/s1200/algorave3.gif"
        itemprop="image"
        width="100%"
      />
      <br />
    ...
    <div class="item">
      <p>2020/02/15に落合soupで行われたAlgorave TokyoでのVJに使用したVisual System．</p>
    </div>
    <div class="itemSub">
      <p>
        ...
        <br />Link :
        <a href="http://ochiaisoup.com/?p=3734" target="_blank">Algorave Tokyo 2020/02/15</a>
        <br />Source Code :
        <a
          href="https://github.com/santa-sukitoku/AlgoraveTokyo"
          target="_blank"
        >GitHub</a>
      </p>
    </div>
