<template>
  <section class="container">
    <body class="allContent">
      ...
      <div class="item">
        <p>
          慶應義塾大学SFCコンピュータミュージック1の最終課題．
          <br />大学キャンパス内で普段は物体として捉えている"森"を"Sound"として認識させる音楽．Ambient
          Soundを主体としているが，ところどころ"自分の声"を入れることで"森と人の協調"を表現している．
        </p>
      </div>
      <div class="itemSub">
        <p>
          ...
          <br />Link :
          <a href="https://soundcloud.com/santa-n/i-forest" target="_blank"
            >SoundCloud</a
          >
        </p>
      </div>
...
export default {
  head() {
    return {
      title: "Computer Music1 final work (I & Forest)",
    };
  },
};
</script>
